...
#sena was here too!
rm -r ~/Documents/UnrealProjects/LandscapeMountains\ 4.18/Plugins
rsync -t -r ~/Gitstuff/AirSim/Unreal/Plugins/ ~/Documents/UnrealProjects/LandscapeMountains\ 4.18/Plugins
