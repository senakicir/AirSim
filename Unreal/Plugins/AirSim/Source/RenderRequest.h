...
public:
    ...
    //sena was here
    void getScreenshot(std::shared_ptr<RenderParams> params[], std::vector<std::shared_ptr<RenderResult>>& results, unsigned int req_size , const Vector3r_arr* bonesPosPtr, Vector3r_arr& accurate_bones);
